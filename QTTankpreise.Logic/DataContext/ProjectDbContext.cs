...
namespace QTTankpreise.Logic.DataContext
{
    ...
    {
#if SQLSERVER_ON
        private static readonly string ConnectionString = "Data Source=(localdb)\\MSSQLLocalDB;Database=QTTankpreiseDb;Integrated Security=True";
#endif
#if SQLITE_ON
        private static readonly string ConnectionString = "Data Source=/Users/gerhardgehrer/Projects/Data/QTTankpreise.db";
#endif
        /// <summary>
