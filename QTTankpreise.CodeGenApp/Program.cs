//@CodeCopy
//MdStart
namespace QTTankpreise.CodeGenApp
{
    ...
    internal partial class Program
    {
        ...
        private static void RunApp()
        {
            ...
            {
                Console.Clear();
                Console.WriteLine($"Code generation for: {nameof(QTTankpreise)}");
                Console.WriteLine("=============================================");
                Console.WriteLine();
        ...
        private static string GetCurrentSolutionPath()
        {
            int endPos = AppContext.BaseDirectory
                                   .IndexOf("QTTankpreise.CodeGenApp", StringComparison.CurrentCultureIgnoreCase);
